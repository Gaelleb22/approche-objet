...
public class ReflectionUtils {
	public static void afficherAttributs(Object obj) throws IllegalArgumentException, IllegalAccessException, ReflexionException {

		if(obj == null) {
			throw new ReflexionException("Pas d'objet en paramètre");
		}
